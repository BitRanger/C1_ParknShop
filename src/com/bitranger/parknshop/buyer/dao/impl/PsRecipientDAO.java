 ...
 */
public class PsRecipientDAO extends HibernateDaoSupport {
	...
	public List<PsRecipient> findByExample(PsRecipient instance) {
		...
		try {
			...
			List<PsRecipient> results = getHibernateTemplate()
	...
	public List<PsRecipient> findByProperty(String propertyName, Object value) {
	...
	@SuppressWarnings("unchecked")
	public List<PsRecipient> findAll() {
	...
	public PsRecipient merge(PsRecipient detachedInstance) {
		...
		try {
			PsRecipient result = getHibernateTemplate().merge(
					detachedInstance);
