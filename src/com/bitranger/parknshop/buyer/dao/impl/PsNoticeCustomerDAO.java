...
import com.bitranger.parknshop.buyer.dao.IPsNoticeCustomerDAO;
 ...
 */
public class PsNoticeCustomerDAO extends HibernateDaoSupport implements IPsNoticeCustomerDAO {
	...
	public static IPsNoticeCustomerDAO getFromApplicationContext(
			ApplicationContext ctx) {
		return (IPsNoticeCustomerDAO) ctx.getBean("PsNoticeCustomerDAO");
	}
